    ...
    <WorkshopImpression id={workshop.id} source={source}>
      <article className="h-full">
        <Link
          ...
          className={`group flex h-full flex-col overflow-hidden rounded-2xl border border-[#dedfd3] bg-white transition duration-200 hover:-translate-y-0.5 hover:border-primary/50 hover:shadow-soft-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ${compact ? "p-5" : "p-6 sm:p-7"}`}
        >
          ...
          >
            <span className="decoration-primary/40 underline-offset-4 group-hover:underline">
              {workshop.title}
            </span>
          </h3>
          {!compact ? (
