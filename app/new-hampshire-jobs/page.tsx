...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("new-hampshire-jobs"),
  },
};

export default async function NewHampshireJobsPage() {
  const jobs = await getCachedPublicJobs("new-hampshire-jobs", {
    where: {
      active: true,
