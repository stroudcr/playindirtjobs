...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("louisiana-jobs"),
  },
};

export default async function LouisianaJobsPage() {
  const jobs = await getCachedPublicJobs("louisiana-jobs", {
    where: {
      active: true,
