...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("missouri-jobs"),
  },
};

export default async function MissouriJobsPage() {
  const jobs = await getCachedPublicJobs("missouri-jobs", {
    where: {
      active: true,
