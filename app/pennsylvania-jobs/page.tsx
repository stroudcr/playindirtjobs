...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("pennsylvania-jobs"),
  },
};

export default async function PennsylvaniaJobsPage() {
  const jobs = await getCachedPublicJobs("pennsylvania-jobs", {
    where: {
      active: true,
