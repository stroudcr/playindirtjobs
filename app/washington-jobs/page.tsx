...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("washington-jobs"),
  },
};

export default async function WashingtonJobsPage() {
  const jobs = await getCachedPublicJobs("washington-jobs", {
    where: {
      active: true,
