...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("illinois-jobs"),
  },
};

export default async function IllinoisJobsPage() {
  const jobs = await getCachedPublicJobs("illinois-jobs", {
    where: {
      active: true,
