...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("new-jersey-jobs"),
  },
};

export default async function NewJerseyJobsPage() {
  const jobs = await getCachedPublicJobs("new-jersey-jobs", {
    where: {
      active: true,
