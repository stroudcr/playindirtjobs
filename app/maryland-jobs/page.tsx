...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("maryland-jobs"),
  },
};

export default async function MarylandJobsPage() {
  const jobs = await getCachedPublicJobs("maryland-jobs", {
    where: {
      active: true,
