...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("west-virginia-jobs"),
  },
};

export default async function WestVirginiaJobsPage() {
  const jobs = await getCachedPublicJobs("west-virginia-jobs", {
    where: {
      active: true,
