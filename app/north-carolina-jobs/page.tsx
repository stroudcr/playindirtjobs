...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: stateContent.metaTitle,
    description: stateContent.metaDescription,
    url: getUrl("north-carolina-jobs"),
  ...
  alternates: {
    canonical: getUrl("north-carolina-jobs"),
  },
};

export default async function NorthCarolinaJobsPage() {
  const jobs = await getCachedPublicJobs("north-carolina-jobs", {
    where: {
      active: true,
