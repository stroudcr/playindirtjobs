...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("michigan-jobs"),
  },
};

export default async function MichiganJobsPage() {
  const jobs = await getCachedPublicJobs("michigan-jobs", {
    where: {
      active: true,
