...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("delaware-jobs"),
  },
};

export default async function DelawareJobsPage() {
  const jobs = await getCachedPublicJobs("delaware-jobs", {
    where: {
      active: true,
