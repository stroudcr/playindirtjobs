...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("kentucky-jobs"),
  },
};

export default async function KentuckyJobsPage() {
  const jobs = await getCachedPublicJobs("kentucky-jobs", {
    where: {
      active: true,
