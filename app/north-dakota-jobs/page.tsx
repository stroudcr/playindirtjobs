...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("north-dakota-jobs"),
  },
};

export default async function NorthDakotaJobsPage() {
  const jobs = await getCachedPublicJobs("north-dakota-jobs", {
    where: {
      active: true,
