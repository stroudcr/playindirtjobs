...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("arkansas-jobs"),
  },
};

export default async function ArkansasJobsPage() {
  const jobs = await getCachedPublicJobs("arkansas-jobs", {
    where: {
      active: true,
