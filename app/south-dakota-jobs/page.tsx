...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("south-dakota-jobs"),
  },
};

export default async function SouthDakotaJobsPage() {
  const jobs = await getCachedPublicJobs("south-dakota-jobs", {
    where: {
      active: true,
