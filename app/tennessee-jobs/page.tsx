...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("tennessee-jobs"),
  },
};

export default async function TennesseeJobsPage() {
  const jobs = await getCachedPublicJobs("tennessee-jobs", {
    where: {
      active: true,
