...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("new-mexico-jobs"),
  },
};

export default async function NewMexicoJobsPage() {
  const jobs = await getCachedPublicJobs("new-mexico-jobs", {
    where: {
      active: true,
