...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("california-jobs"),
  },
};

export default async function CaliforniaJobsPage() {
  const jobs = await getCachedPublicJobs("california-jobs", {
    where: {
      active: true,
