...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("massachusetts-jobs"),
  },
};

export default async function MassachusettsJobsPage() {
  const jobs = await getCachedPublicJobs("massachusetts-jobs", {
    where: {
      active: true,
