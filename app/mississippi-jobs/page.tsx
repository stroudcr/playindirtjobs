...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("mississippi-jobs"),
  },
};

export default async function MississippiJobsPage() {
  const jobs = await getCachedPublicJobs("mississippi-jobs", {
    where: {
      active: true,
