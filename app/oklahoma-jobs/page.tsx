...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("oklahoma-jobs"),
  },
};

export default async function OklahomaJobsPage() {
  const jobs = await getCachedPublicJobs("oklahoma-jobs", {
    where: {
      active: true,
