...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("wisconsin-jobs"),
  },
};

export default async function WisconsinJobsPage() {
  const jobs = await getCachedPublicJobs("wisconsin-jobs", {
    where: {
      active: true,
