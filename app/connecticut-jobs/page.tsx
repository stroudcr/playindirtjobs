...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("connecticut-jobs"),
  },
};

export default async function ConnecticutJobsPage() {
  const jobs = await getCachedPublicJobs("connecticut-jobs", {
    where: {
      active: true,
