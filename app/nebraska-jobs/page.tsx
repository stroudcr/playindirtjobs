...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("nebraska-jobs"),
  },
};

export default async function NebraskaJobsPage() {
  const jobs = await getCachedPublicJobs("nebraska-jobs", {
    where: {
      active: true,
