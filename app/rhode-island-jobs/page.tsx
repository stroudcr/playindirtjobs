...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getUrl("rhode-island-jobs"),
  },
};

export default async function RhodeIslandJobsPage() {
  const jobs = await getCachedPublicJobs("rhode-island-jobs", {
    where: {
      active: true,
