...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: stateContent.metaTitle,
    description: stateContent.metaDescription,
    url: getUrl("south-carolina-jobs"),
  ...
  alternates: {
    canonical: getUrl("south-carolina-jobs"),
  },
};

export default async function SouthCarolinaJobsPage() {
  const jobs = await getCachedPublicJobs("south-carolina-jobs", {
    where: {
      active: true,
