...
export const STATE_CONTENT_MAP: Record<string, StateContent> = {
  ...
  FL: {
    code: 'FL',
    name: 'Florida',
    metaTitle: 'Farm Jobs in Florida | Year-Round Subtropical Agriculture | 300+ Crops',
    metaDescription: 'Find farm jobs in Florida with year-round opportunities across 300+ specialty crops. 60,867 H-2A workers (most in U.S.), #1 in strawberries, sugarcane, tropical plants. $10.2B industry with subtropical/tropical climate enabling continuous production.',
  ...
  TX: {
    code: 'TX',
    name: 'Texas',
    metaTitle: 'Farm Jobs in Texas | #1 Cattle, Cotton & Hay State | 230K Farms',
    metaDescription: 'Find farm jobs in Texas, home to 230,662 farms (most in U.S.), 12 million cattle (#1), and #1 cotton/hay production. $868B agriculture industry with year-round opportunities across ranches, dairies, and crop farms.',
