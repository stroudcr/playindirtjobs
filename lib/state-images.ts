...
const STATE_IMAGES: Record<string, StateImage> = {
  ...
  AK: {
    src: "/images/alaska-jobs-hero.webp",
    alt: "Illustrated Alaska farm with mountains, crops, reindeer, and workers",
  ...
  FL: {
    ...
    alt: "Oranges ripening on a tree under a clear blue sky",
    credit: "Kusano Yui",
    creditUrl: "https://unsplash.com/@kusanoyui",
  },
  GA: {
    src: "https://images.unsplash.com/photo-1542820243-983a04f67b73?w=1920&h=1080&fit=crop",
    alt: "Ripe plums growing on a tree",
    credit: "Joanna Stołowicz",
    creditUrl: "https://unsplash.com/@joanna_stolowicz",
  },
  HI: {
